...
public class ContaBancariaTest {
    ...
    @Test
    void sacarSaldoTotalDeveDeixarSaldoZero() {
        ContaBancaria conta = new ContaBancaria("Maria", "123");
    ...
    @Test
    void doisDepositosDevemSomarOsValores() {
        ContaBancaria conta = new ContaBancaria("Maria", "123");

        conta.depositar(50.0);
        conta.depositar(25.0);

        assertEquals(75.0, conta.getSaldo(), 0.001);
    }

    @Test
    void saqueInvalidoNaoDeveAlterarSaldo() {
        ContaBancaria conta = new ContaBancaria("Maria", "123");
